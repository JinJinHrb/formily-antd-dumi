...
import Collapse, { CollapseProps, CollapsePanelProps } from 'antd/es/collapse'
...
/** antd 中类型声明有错误，需要获取真正的 props */
// type CollapsePanelProps = CollapsePanelComponentType extends React.FC<infer R> ? R : never
// type CollapseProps = CollapsePropsComponentType extends React.FC<infer R> ? R : never
...
export const FormCollapse: ComposedFormCollapse = observer(({ formCollapse, ...props }) => {
	...
	return (
		<Collapse
			{...props}
			className={cls(prefixCls, props.className, 'form-collapse')}
