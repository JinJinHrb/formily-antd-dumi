...
import { FormButtonGroup, Submit, Reset, FormItem, Input, FormLayout } from '@formily/antd-dumi'
	...
	return (
		<XTConfigProvider>
			<FormProvider form={form}>
				<FormLayout layout='horizontal' labelCol={6} wrapperCol={10}>
					<SchemaField>
...
```tsx
import React from 'react'
import { FormButtonGroup, Submit, Reset, FormItem, FormLayout, Input } from '@formily/antd-dumi'
import { createForm } from '@formily/core'
import { FormProvider, createSchemaField } from '@formily/react'
import XTConfigProvider from 'antd/es/config-provider'
