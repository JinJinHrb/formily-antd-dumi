...
import { FormItem, Input, ArrayCollapse, FormButtonGroup, Submit } from '@formily/antd-dumi'
			...
			<FormProvider form={form}>
				<SchemaField>
					<SchemaField.Array
						...
						<SchemaField.Void x-component='ArrayCollapse.Addition' title='添加条目' />
					</SchemaField.Array>
					<SchemaField.Array name='array' maxItems={3} x-decorator='FormItem' x-component='ArrayCollapse'>
						<SchemaField.Object
							x-component='ArrayCollapse.CollapsePanel'
							x-component-props={{
								header: '对象数组',
